...
export default function BlogTeaser() {
  return (
    <section className="px-6 py-12">
      <div className="mx-auto flex max-w-[1296px] gap-12">
        {/* Text content */}
        <div className="flex-1">
          {/* Heading with mixed font weights */}
          <h2 className="mb-6 text-[41px] leading-[1.453] text-white">
          ...
          {/* Body copy */}
          <div className="mb-6 max-w-[526px] text-sm leading-[1.808] text-text-secondary">
            <p className="mb-3">
          ...
          {/* CTA button */}
          <button className="flex items-center gap-2 rounded-xl border border-accent px-5 py-2.5 text-sm font-semibold text-accent transition-colors hover:bg-cta-pill-bg">
            <AddSquare size={16} color="#c9ada7" variant="Linear" />
            <span>ادامه مطلب</span>
          </button>
        </div>

        {/* Right side space (empty in reference, reserved for future blog image) */}
